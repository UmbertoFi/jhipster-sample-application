...
import it.polito.ai.config.audit.AuditEventConverter;
import it.polito.ai.domain.PersistentAuditEvent;
...
import static it.polito.ai.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
