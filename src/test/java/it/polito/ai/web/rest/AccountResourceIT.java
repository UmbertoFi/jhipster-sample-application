...
import it.polito.ai.JhipsterSampleApplicationApp;
import it.polito.ai.config.Constants;
import it.polito.ai.domain.Authority;
import it.polito.ai.domain.User;
import it.polito.ai.repository.AuthorityRepository;
import it.polito.ai.repository.UserRepository;
import it.polito.ai.security.AuthoritiesConstants;
import it.polito.ai.service.MailService;
import it.polito.ai.service.UserService;
import it.polito.ai.service.dto.PasswordChangeDTO;
import it.polito.ai.service.dto.UserDTO;
import it.polito.ai.web.rest.errors.ExceptionTranslator;
import it.polito.ai.web.rest.vm.KeyAndPasswordVM;
import it.polito.ai.web.rest.vm.ManagedUserVM;
